...
function(scpm_create_target)
    ...
    set(one_value_args_type TYPE)
    cmake_parse_arguments(scpm_create_target "${options}" "${one_value_args}" "${one_value_args_type}" "${multi_value_args}" ${ARGN})
    message("${scpm_create_target_TYPE}")
