...
if (NOT EXISTS ${scpm_work_dir}/sqlite3-${scpm_sqlite3_version}.installed)
	scpm_download_and_extract_archive("${scpm_sqlite3_repo}/${scpm_sqlite3_version}/" "sqlite-amalgamation-${scpm_sqlite3_version}.zip")
	# https://www.sqlite.org/2022/sqlite-amalgamation-3370200.zip
	scpm_build_cmake("${scpm_work_dir}/sqlite3-${scpm_sqlite3_version}")
