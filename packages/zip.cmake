...
if (NOT EXISTS ${scpm_work_dir}/zip-${scpm_zip_version}.installed)
    ...
    scpm_build_cmake("${scpm_work_dir}/libzip-${scpm_zip_version}" "-DBUILD_SHARED_LIBS=OFF -DENABLE_OPENSSL=OFF -DENABLE_MBEDTLS=OFF -DENABLE_GNUTLS=OFF -DENABLE_COMMONCRYPTO=OFF -DENABLE_WINDOWS_CRYPTO=OFF -DENABLE_LZMA=OFF -DENABLE_ZSTD=OFF -DENABLE_BZIP2=OFF")
