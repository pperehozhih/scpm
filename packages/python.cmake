...
if (NOT EXISTS ${scpm_work_dir}/python-${scpm_python_version}.installed)
    scpm_download_github_archive("${scpm_python_repo}" "${scpm_python_version}")
    scpm_build_configure("${scpm_work_dir}/python-${scpm_python_version}")
    scpm_build_make("${scpm_work_dir}/python-${scpm_python_version}")
