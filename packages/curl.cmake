...
if (NOT EXISTS ${scpm_work_dir}/curl-${scpm_curl_version}.installed)
    ...
    if(scpm_platform_windows)
        scpm_build_cmake("${scpm_work_dir}/curl-${scpm_curl_version}" "-DCURL_BUILD_TESTING=OFF" "-DBUILD_SHARED_LIBS=OFF" "-DBUILD_STATIC_LIBS=OFF" "-DBUILD_CURL_EXE=OFF" "-DCURL_USE_SCHANNEL=ON" "-DCURL_USE_WOLFSSL=OFF" "-DUSE_NGHTTP2=OFF" "-DCURL_USE_LIBSSH2=OFF" "-DHTTP_ONLY=ON" "-DUSE_LIBIDN2=OFF" "-DCURL_USE_LIBPSL=OFF")
    else()
