...
if (NOT sfml_lib)
    message(FATAL_ERROR "Please install sfml")
endif()
if (NOT imgui_sfml_version)
    set(imgui_sfml_version "2.0.1")
endif()
...
if (NOT EXISTS ${scpm_work_dir}/imgui-sfml_${imgui_sfml_version})
        ...
        execute_process(
            ...
            WORKING_DIRECTORY ${scpm_work_dir}/imgui-sfml_${imgui_sfml_version}/internal/
