...
if (NOT EXISTS ${scpm_work_dir}/webp-${scpm_webp_version}.installed)
    ...
    scpm_build_cmake("${scpm_work_dir}/webp-${scpm_webp_version}" "-DWEBP_BUILD_ANIM_UTILS=OFF -DWEBP_BUILD_CWEBP=OFF -DWEBP_BUILD_GIF2WEBP=OFF -DWEBP_BUILD_IMG2WEBP=OFF -DWEBP_BUILD_VWEBP=OFF -DWEBP_BUILD_WEBPINFO=OFF -DWEBP_BUILD_WEBPMUX=OFF -DWEBP_BUILD_EXTRAS=OFF -DWEBP_LINK_STATIC=ON")
