...
if (NOT EXISTS ${scpm_work_dir}/boost-${scpm_boost_version}.installed)
    ...
    if (NOT ${BOOST_ENABLE_PYTHON})
        scpm_build_cmake("${scpm_work_dir}/boost-${scpm_boost_version}")
    else()
        scpm_build_cmake("${scpm_work_dir}/boost-${scpm_boost_version}" "-DBOOST_ENABLE_PYTHON=ON -DPython_ROOT_DIR=\"${PYTHON_ROOT_DIR}\"")
    endif()
